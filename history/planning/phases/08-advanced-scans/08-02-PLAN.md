...
files_modified:
  ...
  - crates/ui/src/widgets/property_inspector/mod.rs
  - crates/ui/src/widgets/property_inspector/nested_scan_panel.rs
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "crates/ui/src/graph/nodes.rs"
      provides: "NestedScan node variant and NestedScanConfig"
      contains: "NestedScan"
    - path: "crates/ui/src/widgets/property_inspector/nested_scan_panel.rs"
      provides: "UI panel for nested scan configuration"
      exports: ["NestedScanPanel"]
  key_links:
    - from: "crates/ui/src/graph/nodes.rs"
...
@crates/ui/src/graph/nodes.rs
@crates/ui/src/widgets/property_inspector/mod.rs
@crates/ui/src/widgets/property_inspector/loop_panel.rs
</context>
...
<task type="auto">
  ...
  <files>crates/ui/src/graph/nodes.rs</files>
  <action>
...
<task type="auto">
  ...
  <files>crates/ui/src/widgets/property_inspector/nested_scan_panel.rs, crates/ui/src/widgets/property_inspector/mod.rs</files>
  <action>
...
<task type="auto">
  ...
  <files>crates/ui/src/widgets/node_palette.rs, crates/ui/src/graph/viewer.rs</files>
  <action>
...
1. Build: `cargo build -p ui`
2. Tests: `cargo test -p ui`
3. Format/lint: `cargo fmt --all && cargo clippy -p ui`
