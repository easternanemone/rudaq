...
must_haves:
  ...
  artifacts:
    - path: "crates/ui/src/panels/live_visualization.rs"
      provides: "Live visualization panel integrating camera and plot display"
      exports: ["LiveVisualizationPanel"]
      min_lines: 200
  key_links:
    - from: "crates/ui/src/panels/live_visualization.rs"
      to: "crates/ui/src/panels/multi_detector_grid.rs"
      via: "uses MultiDetectorGrid for layout"
      pattern: "MultiDetectorGrid"
    - from: "crates/ui/src/panels/live_visualization.rs"
      to: "crates/ui/src/widgets/auto_scale_plot.rs"
...
Note: Reuse FrameUpdate from image_viewer module (already public).
  ...
  <verify>
    ...
    - File exists at `crates/ui/src/panels/live_visualization.rs`
