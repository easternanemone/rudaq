...
# Reference patterns
@/Users/briansquires/code/rust-daq/crates/ui/src/panels/storage.rs
@/Users/briansquires/code/rust-daq/crates/ui/src/client.rs
</context>
...
<task type="auto">
  ...
  <files>crates/ui/src/panels/run_history.rs, crates/ui/src/panels/mod.rs</files>
  <action>
...
cargo build -p ui
cargo clippy -p ui -- -D warnings
cargo test -p ui --lib run_history
```
