...
See [PVCAM_SETUP.md](./pvcam-setup.md#camera-stuck-in-exposure_in_progress-status-1) for detailed troubleshooting.
...
cd ~/rust-daq
bash scripts/ops/build-maitai.sh  # Clean rebuild with PVCAM support
