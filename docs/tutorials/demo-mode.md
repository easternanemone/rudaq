...
See [Hardware Drivers Guide](../how-to/hardware-drivers.md) for supported devices.
...
See [Storage Formats Guide](../how-to/storage-formats.md) for storage backends (CSV, HDF5, Arrow).
...
- **[Architecture Guide](../explanation/architecture.md)** — System design
- **[Scripting Guide](../how-to/scripting.md)** — Rhai scripting
- **[Hardware Drivers Guide](../how-to/hardware-drivers.md)** — Add new hardware
