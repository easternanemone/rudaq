...
See [ADR: Buffer Pool Error Handling Strategy](005-pool-error-handling.md) for detailed error handling documentation.
...
- bd-0dax: PVCAM Memory Pool Architecture Migration (Epic)
- [ADR: Buffer Pool Error Handling Strategy](005-pool-error-handling.md)
- [ADR: BufferPool Migration Rollback Plan](006-pool-migration-rollback.md)
- [ADR: PVCAM Driver Architecture](009-pvcam-driver-architecture.md)
