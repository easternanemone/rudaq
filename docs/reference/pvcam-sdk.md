...
**CRITICAL:** Mixing buffer modes and retrieval methods causes buffer stalls. See ../adr/008-pvcam-continuous-acquisition.md lines 215-253 for detailed explanation.
...
- **Troubleshooting**: `../how-to/pvcam-setup.md`
