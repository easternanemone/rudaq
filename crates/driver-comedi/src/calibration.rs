...
//!
//! ```rust,ignore
//! use driver_comedi::calibration::{CalibrationManager, CalibrationPolynomial};
//!
...
impl CalibrationPolynomial {
    ...
    ///
    /// ```
    /// use driver_comedi::calibration::CalibrationPolynomial;
    ///
    ...
    pub fn apply_f64(&self, value: f64) -> f64 {
        ...
        #[expect(
            ...
            reason = "polynomial order is small (< 4), fits in usize"
        )]
    ...
    pub fn apply_inverse(&self, physical_value: f64, maxdata: u32) -> u32 {
        ...
        #[expect(
            ...
            reason = "clamped to [0, maxdata]; round() produces exact integer in u32 range"
        )]
        {
    ...
    #[expect(
        ...
        reason = "polynomial order and index are small integers (< 4), exact in f64"
    )]
