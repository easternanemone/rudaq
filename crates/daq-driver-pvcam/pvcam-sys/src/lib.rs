...
/// FRAME_INFO structure returned by EOF callbacks (bd-ek9n.2, bd-ek9n.3)
///
/// Contains metadata about the acquired frame including hardware frame number
/// which is essential for frame loss detection.
#[cfg(feature = "pvcam-sdk")]
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct FRAME_INFO {
    /// Unique GUID for this frame info
    pub FrameInfoGUID: [u8; 16],
    /// Camera handle that produced this frame
    pub hCam: i16,
    /// Hardware frame number (1-based), used for frame loss detection
    pub FrameNr: i32,
    /// EOF timestamp in PVCAM time units
    pub TimeStamp: i64,
    /// Readout time for this frame
    pub ReadoutTime: i32,
    /// BOF timestamp in PVCAM time units
    pub TimeStampBOF: i64,
}
