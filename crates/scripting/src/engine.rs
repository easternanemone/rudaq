...
//! # Migration Path
//!
//! Replace with [`crate::rhai_engine::RhaiEngine`] for new code:
//!
//! ```rust,ignore
//! // Old V4 code:
...
//!
//! ```rust,ignore
//! use daq_scripting::engine::ScriptHost;
...
#[deprecated(
    since = "0.5.0",
    note = "Use RhaiEngine instead. See docs/how-to/scripting.md. Sunset: v1.0"
)]
