...
//!
//! ```rust,ignore
//! use driver_mock::{MockStageFactory, MockCameraFactory, MockPowerMeterFactory};
...
pub use pattern::{MockCameraPattern, generate_test_pattern};
...
///
/// This function is called by `drivers::link_drivers()` to ensure driver
