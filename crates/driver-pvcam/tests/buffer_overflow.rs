//! PVCAM Circular Buffer Overflow and Wrap-around Diagnostic Tests
//!
//! These tests investigate CIRC_OVERWRITE behavior, buffer alignment requirements,
//! and various acquisition mode configurations. Originally tests 1-17 from
//! the monolithic `circ_buffer_diagnostic.rs`.
//!
//! Run with:
//! ```bash
...
//!     --test buffer_overflow -- --nocapture --test-threads=1'
//! ```
