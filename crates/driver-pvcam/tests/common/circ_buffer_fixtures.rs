...
// PARAM IDs — only define constants NOT generated by bindgen in pvcam_sys.
// Standard PVCAM params (PARAM_SER_SIZE, PARAM_PAR_SIZE, PARAM_BIT_DEPTH,
// PARAM_READOUT_PORT, PARAM_SPDTAB_INDEX, PARAM_GAIN_INDEX, PARAM_EXPOSURE_MODE,
// PARAM_EXPOSE_OUT_MODE, PARAM_CIRC_BUFFER, PARAM_FRAME_BUFFER_SIZE) come from
// `use pvcam_sys::*` and must NOT be redefined here to avoid ambiguity.
