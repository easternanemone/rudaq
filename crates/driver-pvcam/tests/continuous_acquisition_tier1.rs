...
//!   cargo nextest run --profile hardware -p driver-pvcam --features pvcam_sdk \
...
use common::{
    Frame, FrameTracker, FrameValidator, TestStats, assert_errors_within_limit, assert_fps_near,
    assert_frame_count_min, assert_no_duplicate_frames, durations, exposures,
};
