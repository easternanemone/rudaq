...
//! cargo test -p driver-pvcam
//!
//! # Hardware tests (on remote machine with Prime BSI)
//! cargo test -p driver-pvcam --features "pvcam_sdk,hardware_tests" -- --nocapture
//! ```
...
mod mock_features {
    ...
    #[test]
    fn roi_count_mock() {
        use driver_pvcam::components::acquisition::PvcamAcquisition;
