...
// I/O and diagnostics parameter IDs (bd-oqo7.6).
// These are complex macros in master.h that bindgen can't evaluate, so we
// define them manually using the standard PVCAM encoding:
//   type << 24 | class << 16 | ordinal
#[cfg(feature = "pvcam-sdk")]
pub const PARAM_LOGIC_OUTPUT: u32 = 0x0902_003D; // enum, class2, ord=61
#[cfg(feature = "pvcam-sdk")]
pub const PARAM_LOGIC_OUTPUT_INVERT: u32 = 0x0B02_003E; // bool, class2, ord=62
#[cfg(feature = "pvcam-sdk")]
pub const PARAM_CONTROLLER_ALIVE: u32 = 0x0B00_00A8; // bool, class0, ord=168
#[cfg(feature = "pvcam-sdk")]
pub const PARAM_CCS_STATUS: u32 = 0x0100_0019; // int16, class0, ord=25
#[cfg(feature = "pvcam-sdk")]
...
// Post-Processing parameter IDs (bd-ldjy.1).
// When pvcam-sdk feature is enabled, bindgen generates these from pvcam.h.
// Manual constants only needed for mock/non-SDK builds.
#[cfg(not(feature = "pvcam-sdk"))]
pub const PARAM_PP_INDEX: u32 = 0x0102_021F; // int16, class2, ord=543
#[cfg(not(feature = "pvcam-sdk"))]
pub const PARAM_PP_FEAT_NAME: u32 = 0x0C02_021E; // char_ptr, class2, ord=542
#[cfg(not(feature = "pvcam-sdk"))]
pub const PARAM_PP_FEAT_ID: u32 = 0x0602_0225; // uns16, class2, ord=549
#[cfg(not(feature = "pvcam-sdk"))]
pub const PARAM_PP_PARAM_INDEX: u32 = 0x0102_0221; // int16, class2, ord=545
#[cfg(not(feature = "pvcam-sdk"))]
pub const PARAM_PP_PARAM: u32 = 0x0D02_0223; // uns32, class2, ord=547
#[cfg(not(feature = "pvcam-sdk"))]
pub const PARAM_PP_PARAM_NAME: u32 = 0x0C02_0222; // char_ptr, class2, ord=546
#[cfg(not(feature = "pvcam-sdk"))]
pub const PARAM_PP_PARAM_ID: u32 = 0x0602_0226; // uns16, class2, ord=550
