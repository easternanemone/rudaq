...
impl RunEngine {
    ...
    fn check_feedback(&self) -> Option<FeedbackEvent> {
        self.feedback_rx
            .try_lock()
            .ok()
    ...
    fn adapt_scan_point(&self, planned_position: f64, feedback: &FeedbackEvent) -> Option<f64> {
        match feedback {
    ...
    fn drain_feedback_with_adaptation(&self, planned_position: f64) -> Option<f64> {
