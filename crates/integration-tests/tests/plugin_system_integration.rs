...
mod plugin_tests {
    use anyhow::Result;
    use hardware::capabilities::{Actionable, Loggable, Movable, Readable, Settable, Switchable};
    use hardware::plugin::handles::{
    ...
    use hardware::plugin::schema::InstrumentConfig;
    use std::path::Path;
