...
//!
//! ```rust,ignore
//! use common::serial::{open_serial_async, drain_serial_buffer, SharedPort};
//!
//! // Open a serial port
...
///
/// ```rust,ignore
/// use common::serial::SharedPortUnbuffered;
...
///
/// ```rust,ignore
/// use common::serial::{drain_serial_buffer, SharedPort};
///
