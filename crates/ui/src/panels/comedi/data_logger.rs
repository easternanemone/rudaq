...
#[allow(dead_code)] // bd-phzf: used in column-config UI in Phase 2
...
pub struct DataLoggerPanel {
    #[allow(dead_code)] // bd-phzf: used for relative timestamp display in Phase 2
    ...
    show_stats: bool,
    #[allow(dead_code)] // bd-phzf: used in export dialog in Phase 2
    /// Export path
    export_path: String,
