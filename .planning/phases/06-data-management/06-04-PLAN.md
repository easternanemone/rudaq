...
must_haves:
  ...
  artifacts:
    - path: "crates/daq-egui/src/panels/run_comparison.rs"
...
<task type="auto">
  ...
  <files>crates/daq-egui/src/panels/run_comparison.rs, crates/daq-egui/src/panels/mod.rs</files>
  <action>
...
<task type="auto">
  ...
  <files>crates/daq-egui/src/panels/run_comparison.rs</files>
  <action>
...
cargo build -p daq-egui --features storage_hdf5
cargo clippy -p daq-egui --features storage_hdf5 -- -D warnings
cargo test -p daq-egui --lib run_comparison
```
