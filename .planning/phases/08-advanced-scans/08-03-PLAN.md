...
files_modified:
  ...
  - crates/ui/src/widgets/property_inspector/adaptive_scan_panel.rs
...
must_haves:
  ...
  artifacts:
    ...
    - path: "crates/ui/src/widgets/property_inspector/adaptive_scan_panel.rs"
...
<task type="auto">
  <name>Task 1: Add find_peaks dependency to ui</name>
  <files>crates/ui/Cargo.toml</files>
  <action>
...
<task type="auto">
  ...
  <files>crates/ui/src/widgets/property_inspector/adaptive_scan_panel.rs, crates/ui/src/widgets/property_inspector/mod.rs</files>
  <action>
...
- "×" button on each trigger to remove
