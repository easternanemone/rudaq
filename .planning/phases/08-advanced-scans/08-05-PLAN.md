...
must_haves:
  ...
  artifacts:
    ...
    - path: "crates/ui/src/graph/adaptive.rs"
      provides: "Trigger evaluation logic"
      exports: ["evaluate_trigger", "detect_peaks"]
  key_links:
    - from: "crates/ui/src/graph/adaptive.rs"
      to: "find_peaks crate"
...
<task type="auto">
  ...
  <files>crates/ui/src/graph/adaptive.rs, crates/ui/src/graph/mod.rs</files>
  <action>
...
<task type="auto">
  ...
  <files>crates/ui/src/graph/translation.rs</files>
  <action>
...
<task type="auto">
  ...
  <files>crates/ui/src/graph/validation.rs, crates/ui/src/graph/codegen.rs</files>
  <action>
