...
files_modified:
  ...
  - crates/ui/src/widgets/adaptive_alert.rs
...
must_haves:
  ...
  artifacts:
    - path: "crates/ui/src/widgets/adaptive_alert.rs"
  ...
  key_links:
    - from: "crates/ui/src/widgets/adaptive_alert.rs"
      to: "egui::Modal"
...
<task type="auto">
  ...
  <files>crates/ui/src/widgets/adaptive_alert.rs, crates/ui/src/widgets/mod.rs</files>
  <action>
...
pub fn show_adaptive_alert(
    ...
    modal.show(ctx, |ui| {
        ...
        if data.requires_approval {
            ui.horizontal(|ui| {
                if ui.button(RichText::new("✓ Continue").color(Color32::GREEN)).clicked() {
