...
files_modified:
  ...
  - crates/ui/src/widgets/parameter_editor.rs
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "crates/ui/src/widgets/parameter_editor.rs"
  ...
  key_links:
    - from: "crates/ui/src/widgets/parameter_editor.rs"
...
<task type="auto">
  ...
  <files>crates/ui/src/widgets/parameter_editor.rs, crates/ui/src/widgets/mod.rs</files>
  <action>
Create `crates/ui/src/widgets/parameter_editor.rs`:
...
Update `crates/ui/src/widgets/mod.rs` to export:
```rust
...
`cargo test -p ui parameter_editor` runs tests
  </verify>
  <done>
...
ls crates/ui/src/widgets/parameter_editor.rs

# Check integration
grep -n "parameter_editor\|show_parameter_editor" crates/ui/src/panels/experiment_designer.rs
```
</verification>
