...
|----------|----------|--------|---------|
| `crates/ui/src/graph/codegen.rs` | Rhai code generation | EXISTS (705 lines), SUBSTANTIVE, WIRED | Exports graph_to_rhai_script, imported in experiment_designer.rs |
...
| `crates/ui/src/panels/code_preview.rs` | Syntax-highlighted code preview | EXISTS (211 lines), SUBSTANTIVE, WIRED | CodePreviewPanel with egui_code_editor, used in experiment_designer |
| `crates/ui/src/panels/script_editor.rs` | Editable script mode | EXISTS (139 lines), SUBSTANTIVE, WIRED | ScriptEditorPanel with save/save_as, used via eject_to_script() |
