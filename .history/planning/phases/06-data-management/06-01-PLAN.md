...
must_haves:
  ...
  artifacts:
    - path: "crates/ui/src/widgets/metadata_editor.rs"
...
@/Users/briansquires/code/rust-daq/crates/common/src/experiment/document.rs
...
<task type="auto">
  ...
  <files>crates/ui/src/widgets/metadata_editor.rs, crates/ui/src/widgets/mod.rs</files>
  <action>
...
cargo build -p ui
cargo clippy -p ui -- -D warnings
cargo test -p ui --lib metadata_editor
```
