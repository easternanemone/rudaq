...
@crates/ui/src/graph/validation.rs
@crates/experiment/src/plans.rs
@crates/protocol/proto/daq.proto
</context>
...
<task type="auto">
  ...
  <files>crates/ui/src/client.rs</files>
  <action>
...
Proto types are already generated in daq_proto::daq - just need to add to use statement.
  ...
  <verify>
`cargo build -p ui` succeeds with no errors on client.rs
...
<task type="auto">
  ...
  <files>crates/ui/src/graph/translation.rs, crates/ui/src/graph/mod.rs</files>
  <action>
Create new file `crates/ui/src/graph/translation.rs`:
...
<task type="auto">
  ...
  <files>crates/ui/src/graph/validation.rs, crates/ui/src/panels/experiment_designer.rs</files>
  <action>
Update `crates/ui/src/graph/validation.rs`:
...
Update `crates/ui/src/panels/experiment_designer.rs`:
...
grep -n "pause_engine\|resume_engine\|get_engine_status" crates/ui/src/client.rs

# Check translation module exists
ls crates/ui/src/graph/translation.rs
```
</verification>
